...
class CallRepository {
  ...
  void endCall(String callerId, String recieverId, BuildContext context) async {
    try {
  ...
  void endGroupCall(String callerId, String recieverId, BuildContext context) async {
    try {
      await firestore.collection("call").doc(callerId).delete();
       var groupSnapshot = await firestore
          .collection("groups")
